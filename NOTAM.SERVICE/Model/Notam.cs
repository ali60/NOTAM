...
namespace NOTAM.SERVICE.Model
{
    ...
    [Table(Name = "dbo.NTM_NOTAM")]
    public class Notam : NotamBase, IDataErrorInfo
    {
        ...
        public static Notam CreateNewNotam()
        {
            return new Notam();
        }

        public static Notam CreateNewNNotam()
        {
            return new Notam(){NotamType = "N", Status="H"};
        }

        public static Notam CreateNewCNotam()
        {
            return new Notam() { NotamType = "C",Status ="H" };
        }

        public static Notam CreateNewRNotam()
        {
            return new Notam() { NotamType = "R", Status = "H"};
        }
